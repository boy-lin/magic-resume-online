...
import { FileText, SwatchBook, Settings, Bot } from "lucide-react";
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  {sidebarItems.map((item) => (
                    <TooltipProvider delayDuration={200} key={item.title}>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <SidebarMenuItem title={item.title}>
                            ...
                            >
                              <div
                                className="flex justify-center items-center gap-2 p-[8px]"
